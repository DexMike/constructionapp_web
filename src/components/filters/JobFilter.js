...
class JobFilter extends Component {
  ...
  async fetchJobs() {
    ...
    if (profile.companyType === 'Carrier' && window.location.pathname !== url) { // Carrier Job Dashboard
    ...
    } else if (profile.companyType === 'Carrier' && window.location.pathname === url) { // Marketplace
