...
var HEREMap = /** @class */ (function (_super) {
    ...
    function HEREMap(props) {
        ...
        _this.createMap = function () {
            ...
            var HERE = {};
            var layer = defaultLayers.vector.normal.map;
            if (setLayer) {
    ...
    HEREMap.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (prevProps.markersGroup && prevProps.markersGroup != null){
            this.setMarkersGroup(prevProps.markersGroup);
        }
    };
    ...
    HEREMap.prototype.setMarkersGroup = function (group) {
        var map = this.state.map;
        if (map) {
            map.addObject(group);
